...
public class PotentialStoreOverlay extends BalloonItemizedOverlay<StoreOverlayItem> {

	private List<StoreOverlayItem> mOverlays = new ArrayList<StoreOverlayItem>();

	public PotentialStoreOverlay(MapView mapView, List<Store> stores) {
		super(boundCenter(mapView.getResources().getDrawable(R.drawable.exclamation)), mapView);
